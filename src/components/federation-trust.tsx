...
const federations: Fed[] = [
  ...
  { name: "Premier League", src: "/federations/premier-league.png", darkPlate: true },
  { name: "Serie A", src: "/federations/serie-a.svg", darkPlate: true },
  { name: "Bundesliga", src: "/federations/bundesliga.svg", wide: true, darkPlate: true },
        ...
        {federations.map((f) => (
          <img
            ...
            className={cn(
              ...
              f.darkPlate && "dark:rounded-sm dark:bg-white dark:p-0.5",
            )}
          />
        ))}
      </div>
