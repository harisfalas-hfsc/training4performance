...
const PROBLEMS: Problem[] = [
  {
    ...
    a: "€699 per season (365 days) for one team, charged yearly and renewing automatically until you cancel. Every module is included and there is no per-user fee. You cancel from Account → Subscription, and access continues until the end of the season you already paid for.",
  },
  {
