                  ...
                  return (
                    <div key={b} className="rounded-md border border-border bg-surface-2 p-3">
                      <div className="grid min-w-0 gap-2 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
                        <p className="eyebrow min-w-0 text-primary">{b}</p>
          ...
          <SectionTitle
            ...
            right={
              <button
                ...
                className="inline-flex min-h-9 w-full items-center justify-center gap-2 rounded-md border border-border px-3 py-2 text-xs font-semibold text-muted-foreground hover:text-foreground sm:w-auto"
              >
