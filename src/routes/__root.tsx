      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var t=localStorage.getItem('t4p.theme');if(t==='dark'){document.documentElement.classList.add('dark');document.documentElement.style.colorScheme='dark';}}catch(e){}`,
          }}
        />
      </head>
